...
const POPULAR_TEMPLATES = [
  {
    ...
    description:
      "Complete 12-subject Board Table of Specifications (TOS) with 1st Pass, 2nd Pass, and QBank score tracking.",
    topicsCount: 144,
    duration: "6 Months",
  ...
  },
  {
    ...
    description:
      "FAR, AFAR, Auditing, Tax, MAS, and RFBT syllabus breakdown mapped to PRC board weightings.",
    topicsCount: 118,
    duration: "5 Months",
  ...
  },
  {
    ...
    description:
      "Math & Surveying, Hydraulics & Geotechnical, and Structural Design & Construction topic logs.",
    topicsCount: 96,
    duration: "4 Months",
  ...
  },
  {
    ...
    description:
      "Remedial, Civil, Criminal, Political, Commercial, Tax, Labor, and Legal Ethics case laws tracker.",
    topicsCount: 210,
    duration: "7 Months",
  ...
  },
  {
    ...
    description:
      "General Education, Professional Education, and Specialization subject mastery tracker.",
    topicsCount: 75,
    duration: "3 Months",
...
const TESTIMONIALS = [
  {
    quote:
      "Standard Notion templates kept cluttering up. ReviewTrail gave me the exact board exam weightings for the PLE. I could see my weak spots in Pharmacology immediately.",
  ...
  {
    quote:
      "Creating my own CPALE tracker with custom review center phases (First Pass, Intensive Review, Pre-Board Mocks) was seamless. I knew exactly where I stood 30 days before exam day.",
  ...
  {
    quote:
      "The weighted readiness score feature is a lifesaver. Instead of stressing about arbitrary checkmarks, ReviewTrail computed my actual readiness based on Math & Structural weights.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col gap-6 text-left">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                Ditch messy spreadsheets. Create your own custom review trail or clone
                topnotcher-verified templates for{" "}
                <strong className="text-foreground font-semibold">
                  Medical, CPA, Engineering, NCLEX, & Bar
                </strong>{" "}
                exams.
              </p>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center gap-3 mb-12">
          <Badge variant="secondary" className="px-3 py-1 text-xs">
            Designed For Serious Reviewees
          </Badge>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
            How ReviewTrail Transforms Board Prep
          </h2>
          <p className="max-w-2xl text-muted-foreground text-sm sm:text-base">
            Whether you are enrolled in a review center or self-studying, build a review system
            tailored to your exact pace and exam syllabus.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="flex flex-col justify-between border-border/80 hover:border-primary/40 transition-all hover:shadow-md">
            ...
            <CardContent className="text-sm text-muted-foreground leading-relaxed">
              Create your own subject hierarchy, set review phases (1st Pass, Recall, Mock Exam),
              and assign specific question bank targets per module.
            </CardContent>
          ...
          <Card className="flex flex-col justify-between border-border/80 hover:border-primary/40 transition-all hover:shadow-md">
            ...
            <CardContent className="text-sm text-muted-foreground leading-relaxed">
              Automatic interval alerts trigger reviews for topics you completed 14, 30, and 60 days
              ago so knowledge stays fresh on exam day.
            </CardContent>
            <CardFooter className="pt-2">
              <Link
                href="/about"
          ...
          <Card className="flex flex-col justify-between border-border/80 hover:border-primary/40 transition-all hover:shadow-md">
            ...
            <CardContent className="text-sm text-muted-foreground leading-relaxed">
              Don&apos;t treat all topics equally. ReviewTrail calculates readiness based on
              official Board exam weightings (e.g. 35% Math vs 10% Ethics).
            </CardContent>
            <CardFooter className="pt-2">
              <Link
                href="/templates"
          ...
          <Card className="flex flex-col justify-between border-border/80 hover:border-primary/40 transition-all hover:shadow-md">
            ...
            <CardContent className="text-sm text-muted-foreground leading-relaxed">
              Browse pre-configured tracker templates shared by recent topnotchers, review centers,
              and study groups. Clone in 1-click.
            </CardContent>
            <CardFooter className="pt-2">
              <Link
                href="/templates"
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          <div>
            <Badge variant="outline" className="mb-2">
              Exam Syllabi Library
            </Badge>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
              Popular Board Exam Templates
            </h2>
            <p className="text-sm text-muted-foreground mt-1">
              Pre-loaded with official board exam syllabi and topic weightings.
            </p>
          </div>
          <Button
            render={<Link href="/templates" />}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {POPULAR_TEMPLATES.map((tmpl) => (
            <Card
              key={tmpl.id}
              className="flex flex-col justify-between border-border/80 hover:border-primary/40 transition-all hover:shadow-md"
            >
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  <Badge variant="outline" className={`text-[10px] ${tmpl.color}`}>
                    {tmpl.badge}
                  </Badge>
                </div>
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-card border border-border/80 shadow-md">
          <div className="text-center max-w-2xl mx-auto flex flex-col gap-3 mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              Generic Spreadsheets vs. ReviewTrail
            </h2>
            <p className="text-sm text-muted-foreground">
              Standard Excel sheets lack spaced repetition, board weighting formulas, and
              interactive readiness calculations.
            </p>
          </div>
              ...
              <tbody className="divide-y divide-border/60">
                <tr>
                  <td className="py-3.5 px-4 font-medium text-foreground">
                    Official Board Exam Syllabi Templates
                  </td>
                ...
                <tr>
                  <td className="py-3.5 px-4 font-medium text-foreground">
                    Spaced Repetition & Recall Reminders
                  </td>
                  <td className="py-3.5 px-4 text-muted-foreground flex items-center gap-1.5">
                ...
                <tr>
                  <td className="py-3.5 px-4 font-medium text-foreground">
                    Custom Tracker Template Creation
                  </td>
                  <td className="py-3.5 px-4 text-muted-foreground flex items-center gap-1.5">
        ...
        <Accordion className="w-full flex flex-col gap-3">
          <AccordionItem value="faq-1" className="border rounded-xl px-4 bg-card">
            ...
            <AccordionContent className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              Yes! Every template in ReviewTrail can be cloned and fully customized. You can add
              topics, adjust subject weightings to match your review center’s mock exams, rename
              review phases, and set custom target dates.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="faq-2" className="border rounded-xl px-4 bg-card">
            ...
            <AccordionContent className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              Unlike simple checklists, ReviewTrail weights your progress based on the official
              Board Table of Specifications (TOS). For example, if a subject accounts for 35% of
              your board exam score, mastering it increases your overall readiness score
              proportionally more than a 5% subject.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="faq-3" className="border rounded-xl px-4 bg-card">
            ...
            <AccordionContent className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              Yes! ReviewTrail is 100% free for individual examinees to browse templates, create
              custom trackers, and monitor their review progress.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="faq-4" className="border rounded-xl px-4 bg-card">
            ...
            <AccordionContent className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
              Absolutely. You can export your custom tracker configuration code or generate a
              shareable link so your study buddies and review batchmates can clone your exact
              syllabus schedule.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="relative overflow-hidden rounded-3xl bg-primary text-primary-foreground p-8 sm:p-12 text-center flex flex-col items-center gap-6 shadow-xl">
          ...
          <p className="max-w-xl text-sm sm:text-base text-primary-foreground/90 leading-relaxed">
            Join thousands of examinees pacing their review with structured syllabi, active recall
            logs, and real-time score analytics.
          </p>
